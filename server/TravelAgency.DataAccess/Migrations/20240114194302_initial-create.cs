        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Plans_Agencies_AgencyId",
                        column: x => x.AgencyId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AvailableDates_Plans_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContractIterator = table.Column<int>(type: "int", nullable: false),
                    OwnerId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Location = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    DefaultFooter = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContractLocation = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ...
                    ServiceType = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    TransportationType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Body = table.Column<string>(type: "nvarchar(511)", maxLength: 511, nullable: true),
                    EventType = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContractEmailEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContractEmailEvents_Contracts_ContractId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Passengers_Contracts_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contracts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Agencies_OrganizationId",
                table: "Agencies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailableDates_PlanId",
                table: "AvailableDates",
                column: "PlanId");

            migrationBuilder.CreateIndex(
                name: "IX_ContractEmailEvents_ContractId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Passengers_ContractId",
                table: "Passengers",
                column: "ContractId");

            migrationBuilder.CreateIndex(
                name: "IX_Plans_AgencyId",
                table: "Plans",
                column: "AgencyId");
